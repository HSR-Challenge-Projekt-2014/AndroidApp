...
public class PointOfInterest {
    ...
    static {
        /*
            BÄR in St. Gallen
         */
        Region region1 = new Region("kontakt-beacon-01",
                Identifier.parse("F7826DA6-4FA2-4E98-8024-BC5B71E0893E"), Identifier.parse("10244"),
                Identifier.parse("54936"));
        PointOfInterest poi1 = new PointOfInterest(1, "Der Bär in St.Gallen",
                R.drawable.poi_header_bear, new BeaconReference(region1, Room.ONE));
        poi1.addContent(
                new Content(Topic.ADVENTURE, R.drawable.content_abenteuer, R.drawable.bear_bittner,
                        "Grizzlys in Alaska",
                        "Endlich ist der bekannte Berner Biologe und Bärenfotograf " +
                                "David Bittner aus der einsamen Wildnis in Alaska zurück. Mitgebracht hat er faszinierendes und neues Bildmaterial.",
                        "KaKcjpmnA6c"));
        poi1.addContent(new Content(Topic.HISTORIC, R.drawable.content_historisches,
                R.drawable.letzter_baer_der_ch, "Der letzte Bär der Schweiz",
                "Jon Sarott Bischoff und Padruot Fried waren " +
        ...
        poi1.addContent(new Content(Topic.FUN, R.drawable.content_spass, R.drawable.bear_fun,
                "Die meisten Tiere sehen rasiert lustig aus.", "Bären NICHT!"));
        poi1.addContent(
                new Content(Topic.LOVE, R.drawable.content_liebensleben, R.drawable.bear_sex,
                        "Alle Bären glauben, sie seien der Vater", "Normalerweise paart sich " +
        ...
        /*
            FUCHS in Zürich
         */
        Region region2 = new Region("kontakt-beacon-02",
                Identifier.parse("F7826DA6-4FA2-4E98-8024-BC5B71E0893E"), Identifier.parse("31576"),
                Identifier.parse("38281"));
        PointOfInterest poi2 = new PointOfInterest(2, "Der Fuchs in Zürich",
                R.drawable.poi_header_fox, new BeaconReference(region2, Room.TWO));
        poi2.addContent(
                new Content(Topic.HISTORIC, R.drawable.content_historisches, R.drawable.fox_stats,
                        "Entwicklung der Fuchspopulation im 20. Jahrhundert",
                        "Die Jagdstrecke des Fuchses " +
        ...
        poi2.addContent(new Content(Topic.FUN, R.drawable.content_spass, R.drawable.fox_mouse,
                "Mit Feigen fängt man Füchse", "Dass er Dörrobst, Datteln, getrocknete " +
