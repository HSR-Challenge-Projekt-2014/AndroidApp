                ...
                switch (state) {
                    case BluetoothAdapter.STATE_OFF:
                        if (clients.isEmpty()) {
                            ...
                            stopServiceIntent.putExtra(HomeActivity.SECTION,
                                    FragmentName.getId(FragmentName.GUIDE_STOPPED));
                            ...
                            try {
                                ...
                                Log.e(getClass().getName(),
                                        "Could not start Stopped Service Fragment.", e);
                            }
                        } else {
                    ...
                    case BluetoothAdapter.STATE_TURNING_OFF:
                        Toast.makeText(context, getString(R.string.bluetooth_off_stopping),
    ...
    private Beacon getClosestBeacon(Collection<Beacon> beacons) {
        ...
        for (Beacon beacon : beacons) {
            ...
            Log.d(getClass().getName(),
                    "Beacon " + beacon.getId3() + " with distance " + beacon.getDistance());
            if (closestBeacon == null) {
                closestBeacon = beacon;
            } else {
                closestBeacon = closestBeacon.getDistance() > beacon.getDistance() ? beacon
                        : closestBeacon;
            }
        }
